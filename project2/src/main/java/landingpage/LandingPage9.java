...
public class LandingPage9 extends LandingPageObject {
    ...
    public LandingPage9 open(){
        driver.get(PropertyLoader.URL_9);
        return new LandingPage9();
    }
    ...
    public void registerAsUsualUsd100Bonus(String login, String password){
        ControlsHelper.fillTextBox(driver.findElement(By.cssSelector(CSS_REG_LOGIN_FIELD)), login);
        ControlsHelper.fillTextBox(driver.findElement(By.cssSelector(CSS_REG_PASSWORD_FIELD)), password);
