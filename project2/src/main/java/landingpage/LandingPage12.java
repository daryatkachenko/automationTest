...
public class LandingPage12 extends LandingPageObject {
    private static final String CSS_AJAX_PROGRESS = "img[src='/images/loader.gif']";
    private static final String XPATH_CASH_BACK_IMG = "(//img[@alt='100% бонус'])[2]";
    private static final String XPATH_100_BONUS_IMG= "(//img[@alt='10% кэшбек'])[2]";
    private static final String CSS_SUBMIT_GIFT = "#choose-gift-landing-12-submit";
    private static final String CSS_REFUSE_GIFT = "label.link-like";
    ...
    private static final String XPATH_EMPTY_PASSWORD_ERROR = "//div[@id='popup_register-landing-12']/div/div[2]/div[2]/form/p[2]/span";
    private static final String XPATH_AGREE_ERROR = "//div[@id='popup_register-landing-12']/div/div[2]/div[2]/form/p[4]/span";

    public LandingPage12 open(){
        driver.get(PropertyLoader.URL_12);
        return new LandingPage12();
    }

    public void chooseCashBack(){
        driver.findElement(By.xpath(XPATH_100_BONUS_IMG)).click();
        driver.findElement(By.cssSelector(CSS_SUBMIT_GIFT )).click();
    }
